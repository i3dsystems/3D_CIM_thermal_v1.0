...
parser.add_argument('--gpu', default=0, help='the gpu id')
...
parser.add_argument('--target', type=int, default=0, help='drift target for fixed-direction drift')
