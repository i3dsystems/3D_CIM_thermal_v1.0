...
%     system.hsp.Ygrid = 12e-3;
    ...
    system.pack.Xgrid = 100e-6;
    system.pack.Ygrid = 100e-6;
%     system.pack.Xsize = 10e-3;
%     system.pack.Ysize = 10e-3;
...
%     system.pack.Ygrid = 10e-3;
    ...
    system.chip.Xgrid = 125e-6; %x grid size of chip
    system.chip.Ygrid = 125e-6; %y grid size of chip
...
%     system.layer.ubumps = [2e-6, 3];
    ...
    chip(1).layer.ild = [5e-6, 5]; %metal layer thickness
    chip(1).layer.under = [2e-6, 3]; %underfill bonding thickness; between two dies
...
%     chip(1).blk_name(8) = cellstr('Core');
    ...
    chip1_chip2_middle_ILD_thickness = 2e-6;
    chip2_thickness = 3e-6;
    ...
    chip(2).layer.under = [2e-6, 3]; %underfill bonding thickness; between two dies
...
%     chip(1).blk_name(8) = cellstr('Core');
    ...
    tier2_tier3_middle_ILD_thickness = 2e-6;
    chip3_thickness = 5e-6;

    chip(3).layer.mold_b = [tier2_tier3_middle_ILD_thickness, 5];
    chip(3).layer.die = [chip3_thickness, 2]; %die thickness
    chip(3).layer.ild = [5e-6, 5]; %metal layer thickness
    chip(3).layer.under = [2e-6, 3]; %underfill bonding thickness; between two dies
...
%     chip(3).blk_name(8) = cellstr('Core');
    ...
    chip4_mold_thickness = 2e-6;
    chip4_thickness = 5e-6;
    
    chip(4).layer.mold_b = [chip4_mold_thickness, 5];
    chip(4).layer.die = [chip4_thickness, 2]; %die thickness
    chip(4).layer.ild = [5e-6, 5]; %metal layer thickness
    chip(4).layer.under = [2e-6, 3]; %underfill bonding thickness; between two dies
...
%     chip(4).blk_name(8) = cellstr('Core');
    ...
    chip5_mold_thickness = 2e-6;
    chip5_thickness = 5e-6;
    
    chip(5).layer.mold_b = [chip5_mold_thickness, 5];
    chip(5).layer.die = [chip5_thickness, 2]; %die thickness
    chip(5).layer.ild = [5e-6, 5]; %metal layer thickness
    chip(5).layer.under = [2e-6, 3]; %underfill bonding thickness; between two dies
...
%     chip(5).blk_name(8) = cellstr('Core');
    ...
    chip6_mold_thickness = 2e-6;
    chip6_thickness = 5e-6;
    
    chip(6).layer.mold_b = [chip6_mold_thickness, 5];
    chip(6).layer.die = [chip6_thickness, 2]; %die thickness
    chip(6).layer.ild = [5e-6, 5]; %metal layer thickness
    chip(6).layer.under = [2e-6, 3]; %underfill bonding thickness; between two dies
...
%     chip(3).blk_name(8) = cellstr('Core');
    ...
    chip7_mold_thickness = 2e-6;
    chip7_thickness = 5e-6;
    
    chip(7).layer.mold_b = [chip7_mold_thickness, 5];
    chip(7).layer.die = [chip7_thickness, 2]; %die thickness
    chip(7).layer.ild = [5e-6, 5]; %metal layer thickness
    chip(7).layer.under = [2e-6, 3]; %underfill bonding thickness; between two dies
...
%     chip(3).blk_name(8) = cellstr('Core');
    ...
    chip8_mold_thickness = 2e-6;
    chip8_thickness = 5e-6;
    
    chip(8).layer.mold_b = [chip8_mold_thickness, 5];
    chip(8).layer.die = [chip8_thickness, 2]; %die thickness
    chip(8).layer.ild = [5e-6, 5]; %metal layer thickness
    chip(8).layer.under = [2e-6, 3]; %underfill bonding thickness; between two dies
